...
class Shortcodes {
    ...
    public static function form_v2_direct_fields() {
        return [
            ...
            'property_address1' => 'Address3Street1',
            'property_address2' => 'Address3Street2',
            'property_city'     => 'City3',
            'property_state'    => 'State3',
            'property_zip'      => 'PostalCode3',
            'property_phone'    => 'Phone1',
            'total_units'       => '_ofUnits',
            'software'          => '_PropertyManagementSoftwareUsed',
        ];
    }
    ...
    public static function render_form_v2() {
        ...
        if ( $values['software'] && ! in_array( $values['software'], $software_options, true ) ) {
            array_unshift( $software_options, $values['software'] );
        }
                    ...
                    <section class="pp-form-v2__panel is-active" data-pp-step="1">
                        ...
                        <div class="pp-form-v2__grid">
                            <label class="pp-field pp-field--full">Property Name
                                <input name="property_name" type="text" value="<?php echo esc_attr( $values['property_name'] ); ?>" placeholder="Enter property name" required>
                            </label>
                            <label class="pp-field pp-field--span-8">Property Mailing Address
                                <input name="property_address1" type="text" value="<?php echo esc_attr( $values['property_address1'] ); ?>" placeholder="Enter U.S. Postal (USPS) address" required>
                            </label>
                            <label class="pp-field pp-field--span-4">Unit or Suite # or Leasing Office
                                <input name="property_address2" type="text" value="<?php echo esc_attr( $values['property_address2'] ); ?>" placeholder="Unit # or leasing office">
                            </label>
                            <label class="pp-field pp-field--span-6">City
                                <input name="property_city" type="text" value="<?php echo esc_attr( $values['property_city'] ); ?>" placeholder="Enter city" required>
                            </label>
                            <label class="pp-field pp-field--span-3">State
                                <input name="property_state" type="text" value="<?php echo esc_attr( $values['property_state'] ); ?>" placeholder="State" required>
                            </label>
                            <label class="pp-field pp-field--span-3">Zip Code
                                <input name="property_zip" type="text" value="<?php echo esc_attr( $values['property_zip'] ); ?>" placeholder="Zip code" required>
                            </label>
                            <label class="pp-field pp-field--span-6">Phone Number
                                <input name="property_phone" type="tel" value="<?php echo esc_attr( $values['property_phone'] ); ?>" placeholder="(000) 000-0000">
                            </label>
                            <label class="pp-field pp-field--span-6">Total Number of Units
                                <input name="total_units" type="number" min="0" value="<?php echo esc_attr( $values['total_units'] ); ?>" placeholder="Enter number of units" required>
                            </label>
                        </div>
                        ...
                        <label class="pp-field pp-field--medium">What property management system software do you use?
                            <select name="software">
                                ...
                                <?php foreach ( $software_options as $option ) : ?>
                                    <option value="<?php echo esc_attr( $option ); ?>" <?php selected( $values['software'], $option ); ?>><?php echo esc_html( $option ); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </label>
                        <div class="pp-form-v2__conditional" data-pp-show-if="software:Other">
